...
constexpr bool has_clean_session(char v) { return (v & clean_session) != 0; }

constexpr bool has_clean_start(char v) { return (v & clean_start) != 0; }

constexpr bool has_will_flag(char v) { return (v & will_flag) != 0; }

constexpr retain has_will_retain(char v) {
    return ((v & will_retain) != 0) ? retain::yes : retain::no;
}

constexpr bool has_password_flag(char v) { return (v & password_flag) != 0; }

constexpr bool has_user_name_flag(char v) { return (v & user_name_flag) != 0; }
