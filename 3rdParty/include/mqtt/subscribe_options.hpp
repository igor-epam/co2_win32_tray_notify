...
struct subscribe_options final {
    ...
    constexpr subscribe_options operator|(subscribe_options rhs) const {
        return subscribe_options(data_ | rhs.data_);
    }
    constexpr subscribe_options operator|(retain_handling rhs) const {
        return *this | subscribe_options(rhs);
    }
    ...
    constexpr nl get_nl() const { return static_cast<nl>(data_ & 0b00000100); }
...
constexpr subscribe_options operator|(retain_handling lhs, rap rhs) {
    return subscribe_options(lhs) | rhs;
}
...
constexpr char const* retain_handling_to_str(retain_handling v) {
    switch (v) {
        case retain_handling::send:
            return "send";
        case retain_handling::send_only_new_subscription:
            return "send_only_new_subscription";
        case retain_handling::not_send:
            return "not_send";
        default:
...
inline std::ostream& operator<<(std::ostream& os, retain_handling val) {
...
inline std::ostream& operator<<(std::ostream& os, rap val) {
    os << rap_to_str(val);
    return os;
}
...
inline std::ostream& operator<<(std::ostream& os, nl val) {
    os << nl_to_str(val);
    return os;
}
...
inline std::ostream& operator<<(std::ostream& os, qos val) {
    os << qos_to_str(val);
    return os;
}
