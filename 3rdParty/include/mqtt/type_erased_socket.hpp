...
class socket {
   public:
    ...
    virtual void async_read(
        as::mutable_buffer, std::function<void(error_code, std::size_t)>) = 0;
    virtual void async_write(std::vector<as::const_buffer>,
        std::function<void(error_code, std::size_t)>) = 0;
    virtual std::size_t write(
        std::vector<as::const_buffer>, boost::system::error_code&) = 0;
    ...
    virtual void async_clean_shutdown_and_close(
        std::function<void(error_code)>) = 0;
