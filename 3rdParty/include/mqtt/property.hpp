...
struct n_bytes_property {
    explicit n_bytes_property(property::id id) : id_(id) {}
    ...
    n_bytes_property(
        property::id id, boost::container::static_vector<char, N> buf)
     ...
     * @return id
     */
    property::id id() const { return id_; }

    /**
     * @brief Get whole size of sequence
     * @return whole size
     */
    std::size_t size() const { return 1 + buf_.size(); }

    /**
     * @brief Get number of element of const_buffer_sequence
     * @return number of element of const_buffer_sequence
     */
    static constexpr std::size_t num_of_const_buffer_sequence() { return 2; }
...
struct binary_property {
    binary_property(property::id id, buffer buf)
        : id_(id),
          buf_(force_move(buf)),
          length_{
              num_to_2bytes(boost::numeric_cast<std::uint16_t>(buf_.size()))} {
     ...
     * @return whole size
     */
    std::size_t size() const { return 1 + length_.size() + buf_.size(); }
    ...
    constexpr buffer const& val() const { return buf_; }
...
struct variable_property {
    variable_property(property::id id, std::size_t value) : id_(id) {
     ...
     * @return whole size
     */
    std::size_t size() const { return 1 + value_.size(); }
...
class payload_format_indicator : public detail::n_bytes_property<1> {
   public:
    ...
    payload_format val() const {
        return ((buf_.front() == 0) ? binary : string);
    }

    static constexpr detail::ostream_format const of_ =
        detail::ostream_format::binary_string;
};
...
class message_expiry_interval : public detail::n_bytes_property<4> {
   public:
    ...
    message_expiry_interval(std::uint32_t val)
        : detail::n_bytes_property<4>(
              id::message_expiry_interval, num_to_4bytes(val)) {}
...
class content_type : public detail::string_property {
   public:
    explicit content_type(buffer val, bool already_checked = false)
        : detail::string_property(
              id::content_type, force_move(val), already_checked) {}
};
...
class response_topic : public detail::string_property {
   public:
    explicit response_topic(buffer val, bool already_checked = false)
        : detail::string_property(
              id::response_topic, force_move(val), already_checked) {}
};
...
class subscription_identifier : public detail::variable_property {
   public:
    ...
    subscription_identifier(std::size_t subscription_id)
        : detail::variable_property(
              id::subscription_identifier, subscription_id) {}
};
...
class session_expiry_interval : public detail::n_bytes_property<4> {
   public:
    ...
    session_expiry_interval(session_expiry_interval_t val)
        : detail::n_bytes_property<4>(
              id::session_expiry_interval, {num_to_4bytes(val)}) {
        static_assert(sizeof(session_expiry_interval_t) == 4,
            "sizeof(sesion_expiry_interval) should be 4");
    }
...
class assigned_client_identifier : public detail::string_property {
   public:
    explicit assigned_client_identifier(
        buffer val, bool already_checked = false)
        : detail::string_property(id::assigned_client_identifier,
              force_move(val), already_checked) {}
};
...
class server_keep_alive : public detail::n_bytes_property<2> {
   public:
    ...
    server_keep_alive(std::uint16_t val)
        : detail::n_bytes_property<2>(
              id::server_keep_alive, {num_to_2bytes(val)}) {}
...
class authentication_method : public detail::string_property {
   public:
    explicit authentication_method(buffer val, bool already_checked = false)
        : detail::string_property(
              id::authentication_method, force_move(val), already_checked) {}
};
...
class will_delay_interval : public detail::n_bytes_property<4> {
   public:
    ...
    will_delay_interval(std::uint32_t val)
        : detail::n_bytes_property<4>(
              id::will_delay_interval, {num_to_4bytes(val)}) {}
...
class request_response_information : public detail::n_bytes_property<1> {
   public:
    ...
    request_response_information(bool value)
        : detail::n_bytes_property<1>(
              id::request_response_information, {value ? char(1) : char(0)}) {}
...
class response_information : public detail::string_property {
   public:
    explicit response_information(buffer val, bool already_checked = false)
        : detail::string_property(
              id::response_information, force_move(val), already_checked) {}
};
...
class server_reference : public detail::string_property {
   public:
    explicit server_reference(buffer val, bool already_checked = false)
        : detail::string_property(
              id::server_reference, force_move(val), already_checked) {}
};
...
class reason_string : public detail::string_property {
   public:
    explicit reason_string(buffer val, bool already_checked = false)
        : detail::string_property(
              id::reason_string, force_move(val), already_checked) {}
};
...
class receive_maximum : public detail::n_bytes_property<2> {
   public:
    ...
    receive_maximum(receive_maximum_t val)
        : detail::n_bytes_property<2>(
              id::receive_maximum, {num_to_2bytes(val)}) {}
...
class topic_alias_maximum : public detail::n_bytes_property<2> {
   public:
    ...
    topic_alias_maximum(topic_alias_t val)
        : detail::n_bytes_property<2>(
              id::topic_alias_maximum, {num_to_2bytes(val)}) {}
...
class maximum_qos : public detail::n_bytes_property<1> {
   public:
    ...
    maximum_qos(qos value)
        : detail::n_bytes_property<1>(
              id::maximum_qos, {static_cast<char>(value)}) {
        if (value != qos::at_most_once && value != qos::at_least_once &&
            value != qos::exactly_once)
            throw property_parse_error();
    }
    ...
    std::uint8_t val() const { return static_cast<std::uint8_t>(buf_.front()); }

    static constexpr const detail::ostream_format of_ =
        detail::ostream_format::int_cast;
};
...
class retain_available : public detail::n_bytes_property<1> {
   public:
    ...
    retain_available(bool value)
        : detail::n_bytes_property<1>(
              id::retain_available, {value ? char(1) : char(0)}) {}
...
class user_property {
   public:
    user_property(buffer key, buffer val, bool key_already_checked = false,
        bool val_already_checked = false)
        : key_(force_move(key), key_already_checked),
          val_(force_move(val), val_already_checked) {}
    ...
    constexpr buffer const& key() const { return key_.buf; }

    constexpr buffer const& val() const { return val_.buf; }

    static constexpr detail::ostream_format const of_ =
        detail::ostream_format::key_val;
   ...
   private:
    struct len_str {
        explicit len_str(buffer b, bool already_checked = false)
            : buf(force_move(b)),
              len{num_to_2bytes(
                  boost::numeric_cast<std::uint16_t>(buf.size()))} {
            if (!already_checked) {
        ...
        std::size_t size() const { return len.size() + buf.size(); }
        buffer buf;
...
class maximum_packet_size : public detail::n_bytes_property<4> {
   public:
    ...
    maximum_packet_size(std::uint32_t val)
        : detail::n_bytes_property<4>(
              id::maximum_packet_size, {num_to_4bytes(val)}) {}
...
class wildcard_subscription_available : public detail::n_bytes_property<1> {
   public:
    ...
    wildcard_subscription_available(It b, It e)
        : detail::n_bytes_property<1>(
              id::wildcard_subscription_available, b, e) {}
...
class subscription_identifier_available : public detail::n_bytes_property<1> {
   public:
    ...
    subscription_identifier_available(It b, It e)
        : detail::n_bytes_property<1>(
              id::subscription_identifier_available, b, e) {}
...
class shared_subscription_available : public detail::n_bytes_property<1> {
   public:
    ...
    shared_subscription_available(bool value)
        : detail::n_bytes_property<1>(
              id::shared_subscription_available, {value ? char(1) : char(0)}) {}
...
template <typename Property>
std::enable_if_t<Property::of_ == detail::ostream_format::int_cast,
    std::ostream&>
operator<<(std::ostream& o, Property const& p) {
...
template <typename Property>
std::enable_if_t<Property::of_ == detail::ostream_format::key_val,
    std::ostream&>
operator<<(std::ostream& o, Property const& p) {
    o << p.key() << ':' << p.val();
    return o;
...
template <typename Property>
std::enable_if_t<Property::of_ == detail::ostream_format::binary_string,
    std::ostream&>
operator<<(std::ostream& o, Property const& p) {
...
template <typename Property>
std::enable_if_t<Property::of_ == detail::ostream_format::json_like,
    std::ostream&>
operator<<(std::ostream& o, Property const& p) {
    auto const& v = p.val();
    for (auto const c : v) {
