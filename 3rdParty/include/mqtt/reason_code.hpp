...
inline std::ostream& operator<<(std::ostream& os, suback_return_code val) {
...
inline std::ostream& operator<<(std::ostream& os, connect_reason_code val) {
...
inline std::ostream& operator<<(std::ostream& os, disconnect_reason_code val) {
...
inline std::ostream& operator<<(std::ostream& os, suback_reason_code val) {
...
inline std::ostream& operator<<(std::ostream& os, unsuback_reason_code val) {
...
constexpr bool is_error(puback_reason_code v) {
    return static_cast<std::uint8_t>(v) >= 0x80;
}

inline std::ostream& operator<<(std::ostream& os, puback_reason_code val) {
...
constexpr bool is_error(pubrec_reason_code v) {
    return static_cast<std::uint8_t>(v) >= 0x80;
}

inline std::ostream& operator<<(std::ostream& os, pubrec_reason_code val) {
...
inline std::ostream& operator<<(std::ostream& os, pubrel_reason_code val) {
...
inline std::ostream& operator<<(std::ostream& os, pubcomp_reason_code val) {
...
inline std::ostream& operator<<(std::ostream& os, auth_reason_code val) {
